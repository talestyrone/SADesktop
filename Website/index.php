      ...
      if (isset($_SESSION['username']))
        {
            ...
            echo '<a href="usersettings.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">User Settings</a>';
        }     
        else
        {
            $name = 'Guest';
...
<div class="w3-content" style="max-width:2000px;margin-top:46px"><h4 class="w3-wide">
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
    ...
    <p class="w3-opacity"><i>We host assistance.</i></p>
    <p class="w3-justify">This website can be used by all people who need assistance and also those who are willing to provide said assistance. Create an account and then start a thread and wait for people to reply to your post. It may take minutes or hours but you will eventually get a response that is hopefully - to your liking.</p>
    </div>
  </div>
...
<!-- Chatbox Section -->
<div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
    <h2 class="w3-wide">Chatbox</h2>
    <p class="w3-opacity"><i>Talk with people on-line.</i></p>
    <iframe src="http://deadsimplechat.com/+mXJWr" frameborder="0" width="800px" height="600px"></iframe>
</div>
<!-- End Page Content -->
